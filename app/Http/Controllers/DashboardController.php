...
class DashboardController extends Controller
{
    ...
    public function admindashboard()
    {
        ...
        $submission = sizeof($weekNumber) > 0 ? DB::table('submissions')->where('submission_week', $weekNumber[0]->week_number)->get() : [];
        ...
        return response()->json([
            ...
            "total_mentors" => sizeof($mentors),
            "total_panelists" => sizeof($panelists),
            "total_submissions_in_week" => sizeof($submission),
    ...
    public function panelistdashboard()
    {
        ...
        // Getting total teams
        $cohortTeamsCounts = sizeof($weekNumber) > 0 ? DB::table('cohorts')->where('cohort_id', $weekNumber[0]->cohort_id)->pluck('cohort_teams')
        ...
        return response()->json([
            ...
            "num_submissions" => sizeof($submission)
